...
import { MaterialList } from '../components/product/ProductList';
import { MaterialListView } from '../components/product/ProductListView';
import { MaterialViewTabs } from '../components/product/ProductViewTabs';
import { MOCK_ROOMS } from '../utils/mockData';
import { useStore } from '../store/useStore';

export const MockRoomPage = () => {
